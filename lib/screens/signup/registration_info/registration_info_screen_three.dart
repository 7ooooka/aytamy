...
class RegistrationInfoStepThreeScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _RegistrationInfoStepThreeScreenState();
  }
}

class _RegistrationInfoStepThreeScreenState
    extends State<RegistrationInfoStepThreeScreen> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset(
              "assets/images/shutterstock_95097985.jpg",
              ...
              child: GestureDetector(
                ...
                onTap: () {
                  if (_currentSelectedOption ==
                      CurrentSelectedOption.OPTION_ONE) {
                    showLoading(context);
                    _registrationModel.updateUserwarranty(
                        warranty: 0,
                        onSuccess: () {
                          dismissLoading();
